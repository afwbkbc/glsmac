...
protected:
	...
	Texture* LoadTextureImpl( const std::string& name ) override;
	Texture* LoadTextureImpl( const std::string& name, const size_t x1, const size_t y1, const size_t x2, const size_t y2, const uint8_t flags, const float value ) override;
