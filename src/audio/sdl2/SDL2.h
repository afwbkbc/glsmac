...
#define AUDIO_VOLUME 0.5 // TODO: put to config/settings
#define AUDIO_VOLUME_LOWERING_FROM_ACTORS 0.95 // helps with clicks a bit. it's used as pow( x, number_of_active_channels )
