...
void LoadMapFile::Show() {
	...
	NEW( m_file_browser, ::ui::object::FileBrowser );
		...
		m_file_browser->SetDefaultDirectory( util::FS::GetAbsolutePath( game::world::map::Map::s_consts.fs.default_map_directory ) );
		m_file_browser->SetFileExtension( game::world::map::Map::s_consts.fs.default_map_extension );
