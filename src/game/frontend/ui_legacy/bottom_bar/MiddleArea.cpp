...
void MiddleArea::Create() {
	...
	NEW( m_buttons.messages, ::ui_legacy::object::Button, buttonclass );
	...
	if ( m_game->IsMapEditingAllowed() ) {
		NEW( m_buttons.toolbar, ::ui_legacy::object::Button, buttonclass );
	...
	NEW( m_buttons.info_panels, ::ui_legacy::object::Button, buttonclass );
...
void MiddleArea::SwitchPage( ::ui_legacy::object::Button* active_button, MiddleAreaPage* active_page ) {
