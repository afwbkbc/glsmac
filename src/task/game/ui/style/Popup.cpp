...
void Popup::AddStyles() {
	...
	AddStyle(
		"SectionOuter", SH() {
			...
			s->SetTexture( ::ui::A_TEXTURE_LEFT, "interface.pcx", 40, 275, 40, 298 );
			s->SetTexture( ::ui::A_TEXTURE_TOP, "interface.pcx", 47, 268, 70, 268 );
			s->SetTexture( ::ui::A_TEXTURE_RIGHT, "interface.pcx", 77, 275, 77, 298 );
			s->SetTexture( ::ui::A_TEXTURE_BOTTOM, "interface.pcx", 47, 305, 70, 305 );
	...
	AddStyle(
		"SectionInner", { "Frame" }, SH() {
			...
			s->SetTexture( ::ui::A_HEADER_TEXTURE_LEFT, "interface.pcx", 40, 275, 40, 298 );
			s->SetTexture( ::ui::A_HEADER_TEXTURE_TOP, "interface.pcx", 47, 268, 70, 268 );
			s->SetTexture( ::ui::A_HEADER_TEXTURE_RIGHT, "interface.pcx", 77, 275, 77, 298 );
			s->SetTexture( ::ui::A_HEADER_TEXTURE_BOTTOM, "interface.pcx", 47, 305, 70, 305 );
		}
	);
	...
	AddStyle(
		"LeftLeftFrame", { "LeftFrame" }, SH() {
			s->SetTexture( ::ui::A_TEXTURE, "console_x2_a.pcx", 713, 1, 727, 529 );
			s->Set( ::ui::A_LEFT, -23 );
			s->Set( ::ui::A_WIDTH, 15 );
			s->Set( ::ui::A_TOP, 85 );
		}
	...
	AddStyle(
		"LeftRightFrame", { "LeftFrame" }, SH() {
			s->SetTexture( ::ui::A_TEXTURE, "console_x2_a.pcx", 729, 1, 736, 529 );
			s->Set( ::ui::A_LEFT, -8 );
			s->Set( ::ui::A_WIDTH, 8 );
		}
	);
	...
	AddStyle(
		"RightRightFrame", { "RightFrame" }, SH() {
			s->SetTexture( ::ui::A_TEXTURE, "console_x2_a.pcx", 747, 1, 761, 529 );
			s->Set( ::ui::A_RIGHT, -23 );
			s->Set( ::ui::A_WIDTH, 15 );
			s->Set( ::ui::A_TOP, 85 );
		}
	...
	AddStyle(
		"RightLeftFrame", { "RightFrame" }, SH() {
			s->SetTexture( ::ui::A_TEXTURE, "console_x2_a.pcx", 738, 1, 745, 529 );
			s->Set( ::ui::A_RIGHT, -8 );
			s->Set( ::ui::A_WIDTH, 8 );
		}
	);
	...
	AddStyle(
		"PleaseDontGoImage", SH() {
			...
			s->SetTexture( ::ui::A_TEXTURE, "space_sm.pcx" );
	...
	AddStyle(
		"PleaseDontGoText", SH() {
			...
			s->SetFont( ::ui::A_FONT, "arialn.ttf", 28 );
	...
	AddStyle(
		"PleaseDontGoSound", SH() {
			s->SetSound( ::ui::A_SOUND, "CPU please don't go.wav" );
