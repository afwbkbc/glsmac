	...
	: Vec3Mesh()
{
	...
	/*auto v_one = AddVertex( Vec3Mesh::vec3_t( -RANDNUM, -RANDNUM, Z ) );
	auto v_two = AddVertex( Vec3Mesh::vec3_t( RANDNUM, -RANDNUM, Z ) );
	auto v_three = AddVertex( Vec3Mesh::vec3_t( RANDNUM, RANDNUM, Z ) );
	auto v_four = AddVertex( Vec3Mesh::vec3_t( -RANDNUM, RANDNUM, Z ) );
