...
#include "task/mainmenu/ui_legacy/slidingmenu/MenuBlock.h"
...
#define ADDPART( _part ) \
    { \
        NEWV( part, ui_legacy::object::Surface, _part ); \
...
#undef ADDPART
	...
	NEW( m_label, ui_legacy::object::Label );
...
bool MenuItem::OnMouseDown( const ui_legacy::event::event_data_t* data ) {
	if ( !m_is_title && data->mouse.button == ui_legacy::event::M_LEFT ) {
