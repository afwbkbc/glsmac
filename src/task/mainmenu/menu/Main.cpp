...
Main::Main( MainMenu *mainmenu ) : SlidingMenu( mainmenu, "", {
	{ "START GAME", {
		CH( this ) {
			m_mainmenu->m_settings.global.game_mode = task::GlobalSettings::GM_SINGLEPLAYER;
	...
	{ "QUICK START", {
		CH( this ) {
			...
			// randomize settings
			m_mainmenu->m_settings.global.map.type = task::MapSettings::MT_RANDOM;
			...
			m_mainmenu->m_settings.global.game_rules = task::GlobalSettings::GR_STANDARD;
	...
	{ "SCENARIO", {
		CH( this ) {
			m_mainmenu->m_settings.global.game_mode = task::GlobalSettings::GM_SCENARIO;
	...
	{ "MULTIPLAYER", {
		CH( this ) {
			m_mainmenu->m_settings.global.game_mode = task::GlobalSettings::GM_MULTIPLAYER;
